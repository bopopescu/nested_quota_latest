...
""" Note: Finally, DbQuotaDriver will be renamed as NestedQuotaDiver
    and will become the default quota driver """

class DbQuotaDriver(object):
    """Driver to perform necessary checks to enforce quotas and obtain
    quota information.  The default driver utilizes the local
    database.Later,this name will be changed to NestedQuotaDriver"
    """
    UNLIMITED_VALUE = -1
    ...
    def get_settable_quotas(self, context, resources, project_id,
        ...
        if user_id:
            ...
            if parent_id:
                db_parent_project_quotas = db.quota_get_all_by_project\
                                           (context, parent_id)
